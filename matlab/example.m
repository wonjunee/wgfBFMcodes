...
% Run BFM!
% result = gfBFM(mu, V, obstacle, maxIters, TOL, nt, tau, 'slow', m, gamma, verbose, saveData, filename);
result = gfBFM(mu, V, obstacle, maxIters, TOL, nt, tau, 'incompressible', verbose, saveData, filename);
