...
void mexFunction( int nlhs, mxArray *plhs[],
    ...
    mxGetString(prhs[8], input_char, charSize);
    ...
    BackAndForthIncompressible* bf       = new BackAndForthIncompressible(n1,n2,max_iteration,tolerance,tau); // incompressible
    // Initialize the internal energy functional U
    Helper_U_incompressible*    helper_f = new Helper_U_incompressible(n1,n2,tau,mu);    
    // Set a potential V
    helper_f->set_V(V);
    // Set an obstacle
